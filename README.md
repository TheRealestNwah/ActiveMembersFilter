...
This plugin was written with substantial help from AI. The code was largely generated by
[Claude](https://www.anthropic.com/claude) (Anthropic) through Claude Code, working from
